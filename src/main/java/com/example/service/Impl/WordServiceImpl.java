...
public class WordServiceImpl implements WordService {
    ...
    @Override
    public PageInfo<Word> queryAllWord(String keywords, Integer pageNum, Integer pageSize) {
        // 设置分页参数
        PageHelper.startPage(pageNum, pageSize);
        List<Word> list = wordMapper.queryAllWord(keywords);
        return new PageInfo<Word>(list);
    }
    ...
    public List<Word> queryWordByName(String name) {
        return wordMapper.queryWordByNameLike(name);
    }
