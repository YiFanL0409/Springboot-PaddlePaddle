...
public interface TaskDetailMapper {
     ...
     * @param taskId
     */
    void deleteTaskDetailByTaskId(@Param("taskId") Integer taskId);

    Integer countDaysByTaskIdAndUserId(@Param("taskId") Integer taskId,
                                       @Param("userId") String userId);

    List<Word> getTodayStudyWord(@Param("taskId") Integer taskId,
                                 @Param("userId") String userId);


    Integer countByDays(@Param("taskId") Integer taskId,
                        @Param("userId") String userId,
